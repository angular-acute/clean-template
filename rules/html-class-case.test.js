  ...
  describe("case: kebab", () => {
    ...
    ruleTester.run("kebab-case", rule, {
      valid: [
        ...
        // },
        // {
        //   name: `[class]="myClassVariable"`,
        //   code: '<div [class]="myClassVariable"></div>',
        //   options,
        // },
        // {
        //   name: `class="kebab-class"`,
        //   code: '<div class="kebab-class"></div>',
        //   options,
        // },
        // {
        //   name: `class="one-class another-class"`,
        //   code: '<div class="one-class another-class"></div>',
        //   options,
        // },
        // {
        //   name: `class="one-class another-class third-class"`,
        //   code: '<div class="one-class another-class third-class"></div>',
        //   options,
        // },
        // {
        ...
        // },
        // {
        //   name: `class="kebab-case-{{ withInterpolation }}-and-{{ more }} and-more"`,
        //   code: '<div class="kebab-case-{{ withInterpolation }}-and-{{ more }} and-more"></div>',
        //   options,
        // },
        // {
        //   name: `class="kebab-case-{{ withInterpolation }} and-another-{{ andMore }}"`,
        //   code: '<div class="kebab-case-{{ withInterpolation }} and-another-{{ andMore }}"></div>',
        //   options,
        // },
        // {
        ...
        // },
        // {
        //   name: `class="ignoredCase {{ withInterpolation }}"`,
        //   code: '<div class="ignoredCase {{ withInterpolation }}"></div>',
      ...
      invalid: [
        ...
        // },
        // {
        //   name: `class="kebab-Case Snot{{ withInterpolation }}"`,
        //   code: '<div class="kebab-Case Snot{{ withInterpolation }}"></div>',
        //   output: '<div class="kebab-case snot-{{ withInterpolation }}"></div>',
        //   options,
        //   errors: [
        //     { message: "Template class attributes should be in kebab-case." },
        //     { message: "Template class attributes should be in kebab-case." },
        ...
        // },
        // {
        //   name: `"kebab-Case{{ withInterpolation | andPipe:arg1:argMethod(a1, a2, a3):'arg3' }}"`,
...
// },
        ...
        // },
                                        {
                                          name: ``,
                                          code: `<div class="snake_case_{{ withVar + 'and_string' + withMethod(someArgument, this.someOther(index)) + { magna: 'carta' } + 512 + [1, 2, 3] + null + false + undefined }}"></div>`,
                                          output: `<div class="snake-case-{{ withVar + 'and_string' + withMethod(someArgument, this.someOther(index)) + { magna: 'carta' } + 512 + [1, 2, 3] + null + false + undefined }}"></div>`,
                                          options,
                                          errors: [
                                            { message: "Template class attributes should be in kebab-case." },
                                          ],
